...
Source0  : https://www.wireshark.org/download/src/all-versions/wireshark-3.0.3.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563426386
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libwireshark.so.12.0.3
/usr/lib64/libwiretap.so.9
/usr/lib64/libwiretap.so.9.0.3
