...
Version  : 4.2.3
Release  : 96
URL      : https://2.na.dl.wireshark.org/src/wireshark-4.2.3.tar.xz
Source0  : https://2.na.dl.wireshark.org/src/wireshark-4.2.3.tar.xz
...
%prep
%setup -q -n wireshark-4.2.3
cd %{_builddir}/wireshark-4.2.3
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707962515
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireshark.so.17.0.3
/V3/usr/lib64/libwiretap.so.14.1.3
...
/usr/lib64/libwireshark.so.17.0.3
/usr/lib64/libwiretap.so.14
/usr/lib64/libwiretap.so.14.1.3
