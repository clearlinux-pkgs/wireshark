...
Source0  : https://2.na.dl.wireshark.org/src/wireshark-4.2.1.tar.xz
...
%prep
%setup -q -n wireshark-4.2.1
cd %{_builddir}/wireshark-4.2.1
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704383066
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libwireshark.so.17.0.1
/usr/lib64/libwiretap.so.14
/usr/lib64/libwiretap.so.14.0.1
