...
Source0  : https://www.wireshark.org/download/src/all-versions/wireshark-3.4.2.tar.xz
...
%prep
%setup -q -n wireshark-3.4.2
cd %{_builddir}/wireshark-3.4.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608588259
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/wireshark-3.4.2/COPYING %{buildroot}/usr/share/package-licenses/wireshark/269ab3f57e63fefe9f3aa074305a89c4526c5226
cp %{_builddir}/wireshark-3.4.2/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/wireshark/fad0e142195689a22e56df66f20dbd840679adb9
cp %{_builddir}/wireshark-3.4.2/cmake/modules/LICENSE.txt %{buildroot}/usr/share/package-licenses/wireshark/6a24215d6bbdeb8e9b97926525bcf1958dda4e86
cp %{_builddir}/wireshark-3.4.2/debian/copyright %{buildroot}/usr/share/package-licenses/wireshark/2daa77342f78d75be8baa542e061fcd68a2618e5
cp %{_builddir}/wireshark-3.4.2/debian/license-text-about-dialog %{buildroot}/usr/share/package-licenses/wireshark/0642488f49bf13e818439b5346419da057bb5ed5
cp %{_builddir}/wireshark-3.4.2/epan/dissectors/pidl/IDL_LICENSE.txt %{buildroot}/usr/share/package-licenses/wireshark/41bb27089429d9d6febf18e4237cf04d81fcc737
cp %{_builddir}/wireshark-3.4.2/packaging/wix/COPYING.rtf %{buildroot}/usr/share/package-licenses/wireshark/a20d2f6f5e7e9eb06617df3b88af6192a8147307
pushd clr-build
%make_install
popd
...
/usr/lib64/libwireshark.so.14.0.2
/usr/lib64/libwiretap.so.11
/usr/lib64/libwiretap.so.11.0.2
