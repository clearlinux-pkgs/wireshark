...
Source0  : https://2.na.dl.wireshark.org/src/wireshark-4.2.4.tar.xz
...
%prep
%setup -q -n wireshark-4.2.4
cd %{_builddir}/wireshark-4.2.4
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711846244
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireshark.so.17.0.4
/V3/usr/lib64/libwiretap.so.14.1.4
...
/usr/lib64/libwireshark.so.17.0.4
/usr/lib64/libwiretap.so.14
/usr/lib64/libwiretap.so.14.1.4
