...
Source0  : https://1.na.dl.wireshark.org/src/wireshark-3.6.7.tar.xz
...
%prep
%setup -q -n wireshark-3.6.7
cd %{_builddir}/wireshark-3.6.7
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658967798
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/wireshark-%{version}/debian/copyright %{buildroot}/usr/share/package-licenses/wireshark/9b8918f29fe4f0446c3bf13436841cca67769232
cp %{_builddir}/wireshark-%{version}/debian/license-text-about-dialog %{buildroot}/usr/share/package-licenses/wireshark/0642488f49bf13e818439b5346419da057bb5ed5
...
/usr/lib64/libwireshark.so.15.0.7
/usr/lib64/libwiretap.so.12
/usr/lib64/libwiretap.so.12.0.7
