...
Source0  : https://www.wireshark.org/download/src/all-versions/wireshark-3.0.2.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1558572358
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libwireshark.so.12.0.2
/usr/lib64/libwiretap.so.9
/usr/lib64/libwiretap.so.9.0.2
