...
Source0  : https://2.na.dl.wireshark.org/src/wireshark-4.4.4.tar.xz
...
%prep
%setup -q -n wireshark-4.4.4
cd %{_builddir}/wireshark-4.4.4
%patch -P 1 -p1
pushd ..
cp -a wireshark-4.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739999756
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireshark.so.18.0.4
/V3/usr/lib64/libwiretap.so.15.0.4
...
/usr/lib64/libwireshark.so.18.0.4
/usr/lib64/libwiretap.so.15
/usr/lib64/libwiretap.so.15.0.4
