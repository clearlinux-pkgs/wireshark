...
Source0  : https://1.na.dl.wireshark.org/src/wireshark-4.0.2.tar.xz
...
%prep
%setup -q -n wireshark-4.0.2
cd %{_builddir}/wireshark-4.0.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670512133
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libwireshark.so.16.0.2
/usr/lib64/libwiretap.so.13
/usr/lib64/libwiretap.so.13.0.2
