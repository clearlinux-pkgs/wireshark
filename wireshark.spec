...
Version  : 4.2.5
Release  : 103
URL      : https://2.na.dl.wireshark.org/src/wireshark-4.2.5.tar.xz
Source0  : https://2.na.dl.wireshark.org/src/wireshark-4.2.5.tar.xz
...
%prep
%setup -q -n wireshark-4.2.5
cd %{_builddir}/wireshark-4.2.5
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715816516
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireshark.so.17.0.5
/V3/usr/lib64/libwiretap.so.14.1.5
...
/usr/lib64/libwireshark.so.17.0.5
/usr/lib64/libwiretap.so.14
/usr/lib64/libwiretap.so.14.1.5
