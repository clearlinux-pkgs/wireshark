...
Source0  : https://1.na.dl.wireshark.org/src/wireshark-4.0.1.tar.xz
...
%prep
%setup -q -n wireshark-4.0.1
cd %{_builddir}/wireshark-4.0.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666846512
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libwireshark.so.16.0.1
/usr/lib64/libwiretap.so.13
/usr/lib64/libwiretap.so.13.0.1
