...
%prep
%setup -q -n wireshark-4.4.6
cd %{_builddir}/wireshark-4.4.6
%patch -P 1 -p1
pushd ..
cp -a wireshark-4.4.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744900331
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireshark.so.18.0.6
/V3/usr/lib64/libwiretap.so.15.0.6
...
/usr/lib64/libwireshark.so.18.0.6
/usr/lib64/libwiretap.so.15
/usr/lib64/libwiretap.so.15.0.6
