...
%prep
%setup -q -n wireshark-3.6.8
cd %{_builddir}/wireshark-3.6.8
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662603844
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libwireshark.so.15.0.8
/usr/lib64/libwiretap.so.12
/usr/lib64/libwiretap.so.12.0.8
