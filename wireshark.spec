...
Source0  : https://www.wireshark.org/download/src/all-versions/wireshark-3.2.4.tar.xz
...
%prep
%setup -q -n wireshark-3.2.4
cd %{_builddir}/wireshark-3.2.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589988810
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/wireshark-3.2.4/COPYING %{buildroot}/usr/share/package-licenses/wireshark/269ab3f57e63fefe9f3aa074305a89c4526c5226
cp %{_builddir}/wireshark-3.2.4/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/wireshark/fad0e142195689a22e56df66f20dbd840679adb9
cp %{_builddir}/wireshark-3.2.4/cmake/modules/LICENSE.txt %{buildroot}/usr/share/package-licenses/wireshark/6a24215d6bbdeb8e9b97926525bcf1958dda4e86
cp %{_builddir}/wireshark-3.2.4/debian/copyright %{buildroot}/usr/share/package-licenses/wireshark/2daa77342f78d75be8baa542e061fcd68a2618e5
cp %{_builddir}/wireshark-3.2.4/debian/license-text-about-dialog %{buildroot}/usr/share/package-licenses/wireshark/ad2dad3b8db3cb6125324fc937911e29519cb102
cp %{_builddir}/wireshark-3.2.4/epan/dissectors/pidl/IDL_LICENSE.txt %{buildroot}/usr/share/package-licenses/wireshark/41bb27089429d9d6febf18e4237cf04d81fcc737
cp %{_builddir}/wireshark-3.2.4/packaging/wix/COPYING.rtf %{buildroot}/usr/share/package-licenses/wireshark/a20d2f6f5e7e9eb06617df3b88af6192a8147307
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libwireshark.so.13
/usr/lib64/libwireshark.so.13.0.4
/usr/lib64/libwiretap.so.10
/usr/lib64/libwiretap.so.10.0.4
/usr/lib64/libwsutil.so.11
/usr/lib64/libwsutil.so.11.0.0
/usr/lib64/wireshark/plugins/3.2/codecs/g711.so
/usr/lib64/wireshark/plugins/3.2/codecs/l16mono.so
/usr/lib64/wireshark/plugins/3.2/codecs/sbc.so
/usr/lib64/wireshark/plugins/3.2/epan/ethercat.so
/usr/lib64/wireshark/plugins/3.2/epan/gryphon.so
/usr/lib64/wireshark/plugins/3.2/epan/irda.so
/usr/lib64/wireshark/plugins/3.2/epan/mate.so
/usr/lib64/wireshark/plugins/3.2/epan/opcua.so
/usr/lib64/wireshark/plugins/3.2/epan/profinet.so
/usr/lib64/wireshark/plugins/3.2/epan/stats_tree.so
/usr/lib64/wireshark/plugins/3.2/epan/transum.so
/usr/lib64/wireshark/plugins/3.2/epan/unistim.so
/usr/lib64/wireshark/plugins/3.2/epan/wimax.so
/usr/lib64/wireshark/plugins/3.2/epan/wimaxasncp.so
/usr/lib64/wireshark/plugins/3.2/epan/wimaxmacphy.so
/usr/lib64/wireshark/plugins/3.2/wiretap/usbdump.so
...
/usr/share/package-licenses/wireshark/ad2dad3b8db3cb6125324fc937911e29519cb102
