...
Source0  : https://1.na.dl.wireshark.org/src/wireshark-4.2.0.tar.xz
...
%prep
%setup -q -n wireshark-4.2.0
cd %{_builddir}/wireshark-4.2.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700242644
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libwireshark.so.17.0.0
/usr/lib64/libwiretap.so.14
/usr/lib64/libwiretap.so.14.0.0
