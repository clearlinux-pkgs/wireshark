...
Version  : 3.0.7
Release  : 30
URL      : https://www.wireshark.org/download/src/all-versions/wireshark-3.0.7.tar.xz
Source0  : https://www.wireshark.org/download/src/all-versions/wireshark-3.0.7.tar.xz
...
%prep
%setup -q -n wireshark-3.0.7
cd %{_builddir}/wireshark-3.0.7
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575583115
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/wireshark-3.0.7/COPYING %{buildroot}/usr/share/package-licenses/wireshark/269ab3f57e63fefe9f3aa074305a89c4526c5226
cp %{_builddir}/wireshark-3.0.7/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/wireshark/a51ddfebd46ab5d54c66a85198753740ac9b31ee
cp %{_builddir}/wireshark-3.0.7/cmake/modules/LICENSE.txt %{buildroot}/usr/share/package-licenses/wireshark/6a24215d6bbdeb8e9b97926525bcf1958dda4e86
cp %{_builddir}/wireshark-3.0.7/debian/license-text-about-dialog %{buildroot}/usr/share/package-licenses/wireshark/ad2dad3b8db3cb6125324fc937911e29519cb102
cp %{_builddir}/wireshark-3.0.7/epan/dissectors/pidl/IDL_LICENSE.txt %{buildroot}/usr/share/package-licenses/wireshark/41bb27089429d9d6febf18e4237cf04d81fcc737
cp %{_builddir}/wireshark-3.0.7/packaging/wix/COPYING.rtf %{buildroot}/usr/share/package-licenses/wireshark/a20d2f6f5e7e9eb06617df3b88af6192a8147307
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libwireshark.so.12
/usr/lib64/libwireshark.so.12.0.7
/usr/lib64/libwiretap.so.9
/usr/lib64/libwiretap.so.9.0.7
/usr/lib64/libwscodecs.so.2
/usr/lib64/libwscodecs.so.2.0.0
/usr/lib64/libwsutil.so.10
/usr/lib64/libwsutil.so.10.0.0
/usr/lib64/wireshark/plugins/3.0/codecs/l16mono.so
/usr/lib64/wireshark/plugins/3.0/epan/ethercat.so
/usr/lib64/wireshark/plugins/3.0/epan/gryphon.so
/usr/lib64/wireshark/plugins/3.0/epan/irda.so
/usr/lib64/wireshark/plugins/3.0/epan/mate.so
/usr/lib64/wireshark/plugins/3.0/epan/opcua.so
/usr/lib64/wireshark/plugins/3.0/epan/profinet.so
/usr/lib64/wireshark/plugins/3.0/epan/stats_tree.so
/usr/lib64/wireshark/plugins/3.0/epan/transum.so
/usr/lib64/wireshark/plugins/3.0/epan/unistim.so
/usr/lib64/wireshark/plugins/3.0/epan/wimax.so
/usr/lib64/wireshark/plugins/3.0/epan/wimaxasncp.so
/usr/lib64/wireshark/plugins/3.0/epan/wimaxmacphy.so
/usr/lib64/wireshark/plugins/3.0/wiretap/usbdump.so
...
/usr/share/package-licenses/wireshark/a51ddfebd46ab5d54c66a85198753740ac9b31ee
