...
Source0  : https://2.na.dl.wireshark.org/src/wireshark-4.0.4.tar.xz
...
%prep
%setup -q -n wireshark-4.0.4
cd %{_builddir}/wireshark-4.0.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677863799
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libwireshark.so.16.0.4
/usr/lib64/libwiretap.so.13
/usr/lib64/libwiretap.so.13.0.4
